...
<body>
    <form id="bgForm" class=" text-light text-center py-5 " action="test.php" method="POST">
    <img src="SOLIDAO 1.png" alt="LOGO" width="200" height="190">
